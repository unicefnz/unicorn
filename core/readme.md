...
> If you're using React, check out [the React version](https://github.com/unicef-new-zealand/unicorn/tree/master/packages/react).

Unicorn requires a global stylesheet to be loaded (for global typography and color vars,) documentation for this is a work in progress.
For now, please make sure it's loaded.
