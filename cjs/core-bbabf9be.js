...
const NAMESPACE = 'uniform-components';
...
const patchBrowser = () => {
    ...
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-bbabf9be.js', document.baseURI).href));
