...
const TextField = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: { 'input--has-errors': !!this.errorList.length } }, this.label && core.h("label", { htmlFor: this.uniqueId, class: "caption" }, this.label, " ", optional), core.h("div", { class: "input-field" }, prepend, core.h("input", { class: "input-elem", id: this.uniqueId, disabled: this.disabled, placeholder: this.placeholder, required: !this.optional, value: this.value, onChange: e => this.uniChange.emit(e.target.value), onInput: e => this.uniInput.emit(e.target.value) })), errors));
    }
    renderErrors() {
