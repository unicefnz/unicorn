...
const Button = class {
    ...
    render() {
        ...
        const contents = [
            this.prependIcon && index.h("ion-icon", { name: this.prependIcon, class: "prepend-icon" }),
            (index.h("div", { class: "button-content" }, index.h("slot", null)))
        ];
        return (index.h(index.Host, { class: {
            ...
            } }, this.href ? (index.h("a", { class: "button", href: this.href, onClick: e => isDisabled && e.preventDefault() }, contents)) : (
        // eslint-disable-next-line react/button-has-type
        index.h("button", { class: "button", type: this.buttonType, disabled: isDisabled }, contents))));
    }
};
