...
var Select = /** @class */ (function () {
    ...
    Select.prototype.render = function () {
        var select = (h("div", { class: "select-box" }, h("slot", null), h("ion-icon", { name: "caret-down" })));
