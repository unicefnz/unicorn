...
const Button = class {
    ...
    render() {
        return (h(Host, { class: {
            ...
            } }, h("button", { class: "button", type: this.buttonType, disabled: this.disabled || this.loading }, this.prependIcon && h("ion-icon", { name: this.prependIcon, class: "prepend-icon" }), h("div", { class: "button-content" }, h("slot", null)))));
    }
